#include <singleViewPoseAdjuster.h>

singleViewPoseAdjuster::singleViewPoseAdjuster()
{
}
...
void singleViewPoseAdjuster::solve_singleViewPoseAdjuster()
{
    const char *inputFileName;
	const char *outputFileName;

    inputFileName = "../files/ceres_input_singleViewPoseAdjuster.txt";
	outputFileName = "../files/ceres_output_singleViewPoseAdjuster.txt";
...
/*int main()
{
	singleViewPoseAdjuster svpa;
	svpa.solve_singleViewPoseAdjuster();
	return 0;
}*/